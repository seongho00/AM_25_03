...
public class Main {
    ...
    private static void makeTestData() {
        ...
        members.add(new Member(1, "2024-12-12 12:12:12", "123", "123", "김철수"));
        members.add(new Member(2, Util.getNowStr(), "456", "456", "오영희"));
        members.add(new Member(3, Util.getNowStr(), "testId", "testPw", "테스트"));
